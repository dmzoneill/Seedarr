...
All profiles in `NzbDrone.Core/Simulation/ClientBehavior/Profiles/`. Each uses Azureus-style peer ID: 8-char prefix + 12 random client-specific alphanumeric characters = 20 bytes.
...
| BiglyBT      | `-BI2700-`     | `BiglyBT/2.7.0.0`   | 2.7.0.0 | 6881         |
