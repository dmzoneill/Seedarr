...
function PeerMap() {
  ...
  useEffect(() => {
    ...
    node.filter(d => d.isEncrypted === true)
      .append('circle')
    ...
    node.append('title')
      .text(d => {
        ...
        if (d.type === 'torrent') return `Torrent: ${d.label}\n${d.infoHash || ''}`;
  ...
  return (
    <div>
      ...
      <div className="peer-map-legend">
        ...
        <span className="peer-map-legend-item">
          <span className="peer-map-legend-line" style={{ borderColor: LINK_COLORS.encrypted, borderStyle: 'dashed' }} />
          Encrypted
        </span>
        <span className="peer-map-legend-item">
          <span className="peer-map-legend-line" style={{ borderColor: LINK_COLORS.plain }} />
          Plain
        </span>
      </div>
