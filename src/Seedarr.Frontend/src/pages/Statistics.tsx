...
function Statistics() {
  ...
  const [activeTab, setActiveTab] = useState<"overview" | "achievements" | "buffers">("overview");
  ...
  return (
    <div>
      <div className="page-heading-row" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "0.75rem", marginBottom: "1rem" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
          <h1 className="page-heading" style={{ margin: 0 }}>Statistics & Achievements</h1>
          ...
          >
            <div>
              ...
              <div style={{ fontSize: "0.85rem", color: "var(--text-muted)", marginTop: "0.2rem" }}>
                {achievements.unlockedCount} of {achievements.totalCount} Seeding Milestones Unlocked • {achievements.totalSwarmGuardians.length} Rare Swarms Protected
              </div>
            </div>
          ...
          >
                      ...
                      {topTorrents.length === 0 ? (
                        ...
                        topTorrents.map((t) => (
                          <tr key={t.id} className="torrent-table-row">
                            <td>
                              <Link to="/torrents" style={{ color: "inherit", textDecoration: "none", fontWeight: 500 }}>
                                {t.name}
                              </Link>
                            </td>
            ...
            <div className="card">
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "0.5rem" }}>
                ...
                <span className="badge badge-warning">{achievements.totalSwarmGuardians.length} Rare</span>
              </div>
              <p style={{ fontSize: "0.8rem", color: "var(--text-muted)", margin: "0 0 0.75rem 0" }}>
                Releases with 2 or fewer seeders in the world where you are keeping the archive alive.
              </p>
      ...
      {activeTab === "achievements" && (
        <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
          ...
          <div
            ...
            style={{
              padding: "1.5rem",
              background: "linear-gradient(135deg, rgba(200, 168, 78, 0.2) 0%, rgba(20, 20, 20, 0.95) 100%)",
          ...
          >
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "1rem" }}>
              <div>
                <div style={{ fontSize: "0.85rem", color: "var(--accent)", textTransform: "uppercase", fontWeight: 700, letterSpacing: "0.08em" }}>
                ...
                <div style={{ color: "var(--text-muted)", fontSize: "0.9rem" }}>
                  {achievements.unlockedCount} of {achievements.totalCount} Achievements Complete ({((achievements.unlockedCount / achievements.totalCount) * 100).toFixed(0)}%)
                </div>
              </div>
              ...
              <div style={{ minWidth: "220px", flex: "0 1 300px" }}>
                ...
                <div style={{ width: "100%", height: "10px", backgroundColor: "rgba(0,0,0,0.5)", borderRadius: "5px", overflow: "hidden" }}>
                  <div
                    style={{
            ...
            {achievements.badges.map((badge) => (
              ...
              >
                ...
                <div>
                  ...
                  <div style={{ width: "100%", height: "6px", backgroundColor: "rgba(0,0,0,0.4)", borderRadius: "3px", overflow: "hidden" }}>
                    <div
                      style={{
                        width: `${badge.progress}%`,
                        height: "100%",
                        backgroundColor: badge.isUnlocked ? "var(--success)" : "var(--accent)",
                      }}
                    />
                  </div>
                </div>
      ...
      {activeTab === "buffers" && (
        <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
          <div className="card" style={{ padding: "1.25rem" }}>
            <h3 style={{ margin: "0 0 0.5rem 0" }}>Private Tracker Buffer & Bonus Point Estimator</h3>
            <p style={{ fontSize: "0.85rem", color: "var(--text-muted)", margin: 0 }}>
              Calculates your safe download buffer across trackers before dropping below 1.0 ratio, plus estimated hourly Bonus Points (BP) generated by your active swarms.
            </p>
          </div>
                ...
                <tbody>
                  {trackerBuffers.map((tb) => (
                    <tr key={tb.tracker} className="torrent-table-row">
                      ...
                      <td>
                        <span className={`badge ${tb.ratio >= 2.0 ? "badge-success" : tb.ratio >= 1.0 ? "badge-primary" : "badge-secondary"}`}>
                          {formatRatio(tb.ratio)}
                        </span>
                      </td>
                      <td>
                        <span style={{ fontWeight: 600, color: tb.bufferBytes > 0 ? "var(--success)" : "inherit" }}>
