...
export function DashboardIcon({ size = 16, color = 'currentColor' }: IconProps) {
  return (
...
export function TorrentIcon({ size = 16, color = 'currentColor' }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M4 14V18C4 19.1 4.9 20 6 20H18C19.1 20 20 19.1 20 18V14" stroke={color} strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
}
...
export function SeedIcon({ size = 16, color = 'currentColor' }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M12 4C14.5 6.5 16 10 16 14C16 17.3 14.2 19 12 19C9.8 19 8 17.3 8 14C8 10 9.5 6.5 12 4Z" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M12 8V17" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
      <path d="M12 12C10.5 13.5 10 15 10 16" stroke={color} strokeWidth="1.5" strokeLinecap="round" fill="none" />
      <path d="M12 12C13.5 13.5 14 15 14 16" stroke={color} strokeWidth="1.5" strokeLinecap="round" fill="none" />
    </svg>
  );
}
...
export function BackupIcon({ size = 16, color = 'currentColor' }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M20 16.58A5 5 0 0 0 18 7H17.74A8 8 0 1 0 4 15.25" stroke={color} strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
}
...
export function NetworkIcon({ size = 16, color = 'currentColor' }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M12 3C14.5 5.5 16 8.5 16 12C16 15.5 14.5 18.5 12 21" stroke={color} strokeWidth="2" />
      <path d="M12 3C9.5 5.5 8 8.5 8 12C8 15.5 9.5 18.5 12 21" stroke={color} strokeWidth="2" />
...
export function TagIcon({ size = 16, color = 'currentColor' }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M12.586 2.586A2 2 0 0 0 11.172 2H4a2 2 0 0 0-2 2v7.172a2 2 0 0 0 .586 1.414l8 8a2 2 0 0 0 2.828 0l7.172-7.172a2 2 0 0 0 0-2.828l-8-8Z" stroke={color} strokeWidth="2" />
