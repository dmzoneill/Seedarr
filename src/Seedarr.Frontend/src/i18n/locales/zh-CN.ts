const zhCN = {
  ...
  modals: {
    ...
    gettingStarted: {
      ...
      welcomeDescription:
        "Seedarr 是一款高性能 BitTorrent 客户端，具有自动元数据丰富和本机 *arr 集成。按照本指南连接索引器和媒体管理应用程序。",
      ...
      sonarrStep2:
        "在 Seedarr 中，输入您的 Sonarr URL（默认值：http://localhost:8989）并粘贴您的 API 密钥。",
      sonarrStep3:
        "在 Sonarr 中，转到“设置”>“下载客户端”，单击“+”，选择 qBittorrent，然后将主机设置为 Seedarr IP，将端口设置为 7889。",
      sonarrStep4:
        "单击 Seedarr 中的“测试连接”和“保存并继续”以启用电视节目自动化。",
      name: "姓名",
      type: "类型",
      url: "URL",
      apiKey: "API 密钥",
      ...
      externalUrlHint:
        "浏览器深层链接的可选公共 URL（例如，远程访问 Seedarr 时）。",
      ...
      radarrStep2:
        "在 Seedarr 中，输入您的 Radarr URL（默认值：http://localhost:7878）并粘贴您的 API 密钥。",
      radarrStep3:
        "在 Radarr 中，转到“设置”>“下载客户端”，单击“+”，选择 qBittorrent，并将主机设置为 Seedarr IP，端口设置为 7889。",
      radarrStep4:
        "单击 Seedarr 中的“测试连接”和“保存并继续”以启用电影自动化。",
      lidarrDescription: "激光雷达描述",
      instructionsLidarrCardTitle: "说明 Lidarr 卡标题",
      lidarrStep1:
        "在 Lidarr 中，导航至“设置”>“常规”并复制您的 Lidarr API 密钥。",
      lidarrStep2:
        "在 Seedarr 中，输入您的 Lidarr URL（默认：http://localhost:8686）并粘贴您的 API 密钥。",
      lidarrStep3:
        "在 Lidarr 中，转到“设置”>“下载客户端”，单击“+”，选择 qBittorrent，并将主机设置为 Seedarr IP，端口设置为 7889。",
      lidarrStep4:
        "单击 Seedarr 中的“测试连接”和“保存并继续”以启用音乐自动化。",
      finishTitle: "完成标题",
