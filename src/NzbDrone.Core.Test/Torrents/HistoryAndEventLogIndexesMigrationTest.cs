...
[TestFixture]
public class HistoryAndEventLogIndexesMigrationTest
{
    ...
    [Test]
    public void DbFactory_Create_runs_migration_and_adds_indexes_cleanly()
    {
        ...
        Assert.That(indexes, Does.Contain("IX_DownloadHistory_TorrentId"));
