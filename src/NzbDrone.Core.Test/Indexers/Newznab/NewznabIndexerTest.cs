...
<rss version=""2.0"">
    <channel>
        <item>
            <title>Recent.Usenet.Release</title>
            <guid>recent-nzb-1</guid>
        </item>
    </channel>
</rss>";
            ...
            Assert.That(resultsNull[0].Title, Is.EqualTo("Recent.Usenet.Release"));
...
<rss version=""2.0"">
    <channel>
        <item>
            <title>Rss.Usenet.Release</title>
            <guid>rss-nzb-1</guid>
        </item>
    </channel>
</rss>";
            ...
            Assert.That(results, Has.Count.EqualTo(1));
            Assert.That(results[0].Title, Is.EqualTo("Rss.Usenet.Release"));
