...
public class SecurityMiddlewareTest
{
    ...
    [TestCase("localhost:8096", true)]
    [TestCase("127.0.0.1", true)]
    [TestCase("127.0.0.1:8096", true)]
    [TestCase("::1", true)]
    [TestCase("[::1]", true)]
    [TestCase("[::1]:8096", true)]
    [TestCase("192.168.1.100", true)]
    [TestCase("192.168.1.100:8096", true)]
    [TestCase("10.0.0.5", true)]
    [TestCase("10.0.0.5:8096", true)]
    [TestCase("172.20.0.2", true)]
    [TestCase("172.20.0.2:8096", true)]
    [TestCase("169.254.1.1", true)]
    [TestCase("169.254.1.1:8096", true)]
    ...
    [TestCase("[fe80::1]", true)]
    [TestCase("[fe80::1]:8096", true)]
    [TestCase("fd00::1", true)]
    [TestCase("[fd00::1]", true)]
    [TestCase("[fd00::1]:8096", true)]
    ...
    [TestCase("[2001:db8::1]", false)]
    [TestCase("[2001:db8::1]:8096", false)]
    ...
    [TestCase("example.com", ".example.com", true)]
    [TestCase("sub.example.com", ".example.com", true)]
    [TestCase("example.com:8096", "*.example.com", true)]
    [TestCase("app.example.com:8096", "*.example.com", true)]
    [TestCase("badexample.com", "*.example.com", false)]
    [TestCase("badexample.com:8096", "*.example.com", false)]
    [TestCase("other.com", "*.example.com", false)]
    [TestCase("sub.other.com", "*.example.com", false)]
    [TestCase("sub.local", "*.local", true)]
    [TestCase("myhost.lan", "*.lan", true)]
    [TestCase("app.home.arpa", ".home.arpa", true)]
    [TestCase("home.arpa", ".home.arpa", true)]
    [TestCase("any.domain.org", "*", true)]
    [TestCase("any.domain.org:8096", "*", true)]
    ...
    [TestCase("seedarr.lan")]
    [TestCase("seedarr.lan:8096")]
    [TestCase("app.seedarr.lan:8096")]
    [TestCase("[::1]:8096")]
    [TestCase("127.0.0.1:8096")]
