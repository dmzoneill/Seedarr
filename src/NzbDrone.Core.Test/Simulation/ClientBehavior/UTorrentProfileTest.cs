...
[TestFixture]
public class UTorrentProfileTest
{
    private UTorrentProfile _profile;

    [SetUp]
    public void SetUp()
    {
        _profile = new UTorrentProfile();
    }

    [Test]
    public void Name_should_be_uTorrent_3_5_5()
    {
        Assert.That(_profile.Name, Is.EqualTo("uTorrent 3.5.5"));
    }

    [Test]
    public void PeerIdPrefix_should_be_UT3550()
    {
        Assert.That(_profile.PeerIdPrefix, Is.EqualTo("-UT3550-"));
    }

    [Test]
    public void UserAgent_should_be_correct()
    {
        Assert.That(_profile.UserAgent, Is.EqualTo("uTorrent/3.5.5"));
    }

    [Test]
    public void ClientVersion_should_be_correct()
    {
        Assert.That(_profile.ClientVersion, Is.EqualTo("3.5.5"));
    }
